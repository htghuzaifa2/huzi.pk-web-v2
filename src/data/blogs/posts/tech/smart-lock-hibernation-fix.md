...
1. Safely removing the lock from the door (most smart locks have interior and exterior halves that separate).
2. Opening the interior housing to locate the actuator and its spring mechanism.
3. Carefully tightening or replacing the spring to restore full travel.
4. Reassembling and testing before reinstalling.
