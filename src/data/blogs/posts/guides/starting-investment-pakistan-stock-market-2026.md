...
* **The Documentation:** You need:
    1. A valid CNIC (mandatory — no exceptions)
    2. A Bank Account with an IBAN (for deposits and withdrawals)
    3. A "Next of Kin" (Nominee) detail — this ensures your investments go to your family if something happens to you
    4. Proof of Income (a salary slip, a letter for your own shop/freelancing business, or even a self-declaration for small investors)
    5. Recent utility bill (for address verification)
    6. Two passport-sized photographs (some digital brokers accept phone selfies instead)
