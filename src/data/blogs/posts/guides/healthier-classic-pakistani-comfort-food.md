...
1. Use chicken breast or lean meat instead of bone-in mutton with fat.
2. Double the amount of tomatoes and onions to create a moist "Masala" so you need less oil for cooking.
3. Use a 2:1 ratio of vegetables to rice—potatoes, peas, carrots, and even green beans work beautifully.
4. Avoid "Yellow Food Color" and use real Saffron or Turmeric for health benefits and authentic flavor.
5. Use brown basmati rice or the "Pasaa" (draining) method for white rice.
6. Reduce the salt by 30%—you won't notice the difference after a week of adjustment.
